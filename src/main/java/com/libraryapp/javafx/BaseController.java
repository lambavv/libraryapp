...
public class BaseController {
    ...
    protected  <T> T makePostRequest(String uri, Class<T> responseType, Object postObject) throws IOException, InterruptedException {
    ...
    protected  <T> T makePutRequest(String uri, Class<T> responseType, Object postObject) throws IOException, InterruptedException {
    ...
    protected  <T> T makeDeleteRequest(String uri, Class<T> responseType) throws IOException, InterruptedException {
